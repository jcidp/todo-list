...
const DOMController = (() => {
    ...
    function showEditTask(e) {
        ...
        document.querySelector(".new-task.date").value = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_6__["default"])(task.getDueDate(), "y-MM-d");
