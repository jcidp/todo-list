...
function loadMain(tasks) {
    ...
    tasks.forEach(task => {
        ...
        one_liners.appendChild(
            (0,_helpers_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])("p", task.getPriority(), ["priority", `p${task.getPriority()}`])
        );
        one_liners.appendChild(
            (0,_helpers_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])("p", task.getTitle(), ["task-name"])
        );
        one_liners.appendChild(
            (0,_helpers_createElement__WEBPACK_IMPORTED_MODULE_0__["default"])("p", (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(task.getDueDate(), "MMM d"), ["task-due-date"])
        );
...
const DOMController = (() => {
    ...
    function renderNewListPopup() {
        const popup = (0,_helpers_createElement__WEBPACK_IMPORTED_MODULE_5__["default"])("div", "", ["list", "popup"]);
